...
public class ChampSkinController {
    ...
    public String champSkinView(
        ...
        Page<Skin_comment> commentsPage = champSkinService.getSkinComments(skinCode, pageable);
    ...
    public String skinRateUpdate(
        ...
        // 평점 저장
        Champskinrate skinRate = new Champskinrate(champCode, skinCode, member.getMember_id(), rate);
    ...
    public String skinComWrite(
            @ModelAttribute Skin_comment comment,
