...
public class BoardDTO {
	...
	public Board toEntity() {
    	return new Board(board_num,board_category,detail_category,member_id,nick_name,board_title,board_content,board_img, board_hit,board_recommend,board_report_count, createdAt, createdAt);    	
    }
